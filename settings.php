...
class RealEstateListingSettings{

    private $plugin_path;
    private $plugin_url;
    private $l10n;
    private $pluginTemplate;
    private $namespace = '_real_estate_listing';
    private $settingName = 'Real Estate Listing';
    ...
    function settings_page()
	{
		...
		<div class="wrap">
			...
			<h3>How to use the Real Estate Listing plugin</h3>
			<p>Create a real estate listing by clicking on Real Estate Listing>Add New on the main admin menu.
			<p>Put a real estate listing in your post or page by placing the shortcode tag <code>[real_estate_listing id="%postid%"]</code> on your page or post</p>				
